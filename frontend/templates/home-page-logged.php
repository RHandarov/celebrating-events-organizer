        ...
        <table class="table">
            ...
            <?php
                foreach ($top_20_events as $event) {
                    echo "<tr>";
                    echo "<td><a href=\"/event/" . $event->get_id() . "\">" . $event->get_title() . "</a></td>";
                    echo "<td>" . $event->get_celebrating_date() . "</td>";
                    echo "</tr>";
                }
            ?>
        </table>
        <a href="/all-events">Виж всички събития</a>
    </div>
    <div id="buying-gifts">
        ...
        <table class="table">
            ...
            <?php
                foreach ($user_gifts as $gift) {
                    ...
                    echo "<td><a href=\"/event/" . $gift->get_event()->get_id() . "\">" . $gift->get_event()->get_title() . "</a></td>";
